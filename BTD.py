...
training_set = train_datagen.flow_from_directory('d:/brain/Brain_tumor/train/',
                                                 target_size = (64, 64),
                                                 batch_size = 32,
                                                 class_mode = 'binary')

test_set = test_datagen.flow_from_directory('d:/brain/Brain_tumor/test/',
                                            target_size = (64, 64),
                                            batch_size = 32,
                                            class_mode = 'binary')
...
test_image = image.load_img('d:/brain/TestImages/test8.jpg', target_size = (64, 64))
test_image
